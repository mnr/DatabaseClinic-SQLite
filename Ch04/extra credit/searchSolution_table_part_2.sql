-- A version of the search solution using tables instead of subqueries
-- be sure to run searchSolution_table_part_1.sql before running this

select
   `County Name` as "Year: 2014",
   sum(secondTable.population) as 'Male',
   Female_Pop as 'Female'
from female_population_table
